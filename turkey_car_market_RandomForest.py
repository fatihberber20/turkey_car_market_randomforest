...
random_model_grid=GridSearchCV(random_model, params, cv=10, n_jobs=-1)
random_model_grid.fit(X_train, y_train)

#Retraining the model with the best parameters
random_model_tuned=RandomForestRegressor(n_estimators=random_model_grid.best_params_["n_estimators"], max_depth=random_model_grid.best_params_["max_depth"])
random_model_tuned.fit(X_train, y_train)
y_pred_tuned=random_model_tuned.predict(X_test)
